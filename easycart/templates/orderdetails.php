...
<div class="container" style="max-width: 1200px; margin: 2rem auto; padding: 0 1rem;">
    ...
    <div style="margin-bottom: 1.5rem;">
        <a href="orders.php" style="color: #4f46e5; text-decoration: none; display: inline-flex; align-items: center; gap: 0.5rem; font-weight: 500;">
    ...
    <?php // Removed cancelled check - no cancel functionality ?>
    <div style="background: white; border-radius: 12px; padding: 2rem; margin-bottom: 1.5rem; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
    ...
    <div style="display: grid; grid-template-columns: 1fr 400px; gap: 1.5rem; align-items: start;">
        ...
        <div>
            ...
            <div style="background: white; border-radius: 12px; padding: 2rem; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
                ...
                <div style="display: flex; gap: 1rem; padding: 1rem 0; border-bottom: 1px solid #f3f4f6;">
                    ...
                    <div style="text-align: right;">
                        <p style="margin: 0; font-size: 1.1rem; font-weight: 600; color: #1f2937;">₹<?php echo number_format($item['total'], 2); ?></p>
                        <p style="margin: 0.25rem 0 0; color: #6b7280; font-size: 0.85rem;">₹<?php echo number_format($item['price'], 2); ?> each</p>
                    </div>
                </div>
                <?php endforeach; ?>
            </div>
        ...
        <div style="display: flex; flex-direction: column; gap: 1.5rem;">
            ...
            <div style="display: flex; flex-direction: column; gap: 0.75rem;">
                <a href="invoice.php?id=<?php echo $order['db_id']; ?>" target="_blank" 
