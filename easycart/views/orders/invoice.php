...
<head>
    ...
    <!-- Updated path to public css directory -->
        ...
        <table class="invoice-table">
            ...
            <tbody>
                ...
                foreach($order['items'] as $order_item): 
                    // Price is already formatted as string with commas in controller if we used number_format.
                    // But wait, the controller used number_format($item['price'], 2).
                    // So we must act accordingly. Replace commas for calculation if needed, 
                    // OR better, do calc in controller? The template logic here does calc.
                    // Let's rely on the formatted string but clean it for calc.
                ...
                <tr>
                    ...
                    <td style="text-align: right;">₹<?php echo $order_item['price']; ?></td>
