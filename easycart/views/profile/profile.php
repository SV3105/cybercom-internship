        ...
        <div style="display: grid; grid-template-columns: 250px 1fr; gap: 2rem; max-width: 1400px; margin: 0 auto;">
            ...
            <div style="background: white; border-radius: 12px; padding: 1.5rem; box-shadow: 0 2px 8px rgba(0,0,0,0.08); height: fit-content; position: sticky; top: 20px;">
                ...
                <nav style="display: flex; flex-direction: column; gap: 0.5rem;">
                    ...
                    <div style="margin-top: 1rem; padding-top: 1rem; border-top: 1px solid #e2e8f0;">
                        ...
                        <a href="orders" class="profile-nav-link" style="padding: 0.75rem 1rem; border-radius: 8px; text-decoration: none; color: #64748b; font-weight: 500; display: flex; align-items: center; gap: 0.5rem; transition: all 0.2s;">
                            <i class="fas fa-box" style="width: 16px;"></i>
                            <span>View All Orders</span>
                        </a>
                        <a href="wishlist" class="profile-nav-link" style="padding: 0.75rem 1rem; border-radius: 8px; text-decoration: none; color: #64748b; font-weight: 500; display: flex; align-items: center; gap: 0.5rem; transition: all 0.2s;">
                            <i class="fas fa-heart" style="width: 16px;"></i>
                            <span>My Wishlist</span>
                        </a>
                        <a href="logout" class="profile-nav-link" style="padding: 0.75rem 1rem; border-radius: 8px; text-decoration: none; color: #ef4444; font-weight: 600; display: flex; align-items: center; gap: 0.5rem; transition: all 0.2s; margin-top: 0.5rem; border-top: 1px solid #e2e8f0; padding-top: 1rem;">
            ...
            <div style="display: flex; flex-direction: column; gap: 2rem;">
                ...
                <div id="quick-stats" style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 1.5rem; scroll-margin-top: 20px;">
                    <!-- Orders Card -->
                    <a href="orders" style="background: white; border-radius: 12px; padding: 2rem; box-shadow: 0 2px 8px rgba(0,0,0,0.08); text-decoration: none; transition: all 0.3s; border: 2px solid transparent;">
                    ...
                    <!-- Wishlist Card -->
                    <a href="wishlist" style="background: white; border-radius: 12px; padding: 2rem; box-shadow: 0 2px 8px rgba(0,0,0,0.08); text-decoration: none; transition: all 0.3s; border: 2px solid transparent;">
