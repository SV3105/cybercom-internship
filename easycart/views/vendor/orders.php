<div class="admin-container">
    <div class="dashboard-header" style="text-align: left; display: flex; justify-content: space-between; align-items: center; padding: 1.5rem 2rem;">
        <div>
            ...
            <p style="font-size: 0.95rem; opacity: 0.9;">View and manage customer orders containing your products</p>
        </div>
        ...
        <div class="table-responsive">
            <table class="data-table">
                ...
                <tbody>
                    <?php if (empty($orders)): ?>
                        <tr>
                            <td colspan="7" class="no-data">No orders containing your items have been placed yet.</td>
                        </tr>
                    <?php else: ?>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                <span class="badge" style="background: #f1f5f9; color: #475569; box-shadow: none;">
                                    <?= $order['total_item_count'] ?? '-' ?> matching item(s)
                                </span>
                            </td>
                            <td>
                                <a href="<?= BASE_URL ?>vendor/orderview?id=<?= $order['order_id'] ?>" class="action-btn btn-sm" style="background: white; color: #0891b2; border: 1px solid #bae6fd; box-shadow: none;">
                                    View Details
                                </a>
                            </td>
                        </tr>
