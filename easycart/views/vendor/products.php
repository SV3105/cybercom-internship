...
<div class="admin-container">
    <div class="dashboard-header" style="text-align: left; display: flex; justify-content: space-between; align-items: center; padding: 1.5rem 2rem; flex-wrap: wrap; gap: 1rem;">
        <div>
            <h1 style="font-size: 1.8rem; margin: 0;">My Products</h1>
            <p style="font-size: 0.95rem; opacity: 0.9;">Manage your store's inventory</p>
        </div>
        
        <div style="display: flex; gap: 1rem; align-items: center; flex-grow: 1; justify-content: flex-end;">
            <form action="<?= BASE_URL ?>vendor/products" method="GET" style="display: flex; gap: 0.5rem; flex-grow: 1; max-width: 550px; align-items: stretch; box-sizing: border-box;">
                ...
                <?php if (!empty($_GET['search'])): ?>
                    <a href="<?= BASE_URL ?>vendor/products" class="btn-secondary" style="padding: 0 1.2rem; text-decoration: none; white-space: nowrap; flex-shrink: 0; min-height: 40px; display: flex; align-items: center; justify-content: center; border-radius: 8px; box-sizing: border-box; font-size: 0.9rem;">Clear</a>
                <?php endif; ?>
            </form>

            <a href="<?= BASE_URL ?>vendor/productedit" class="action-btn">
            ...
            <table class="data-table">
                ...
                <tbody>
                    <?php if (empty($products)): ?>
                        <tr>
                            <td colspan="7" class="no-data">No products found in your catalog.</td>
                        </tr>
                    <?php else: ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="display: flex; gap: 0.5rem;">
                                    <a href="<?= BASE_URL ?>vendor/productedit?id=<?= $product['entity_id'] ?>" class="action-btn btn-sm" style="background: white; color: #0891b2; border: 1px solid #bae6fd; box-shadow: none;">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a href="<?= BASE_URL ?>vendor/productdelete?id=<?= $product['entity_id'] ?>" class="action-btn btn-sm" style="background: white; color: #ef4444; border: 1px solid #fecaca; box-shadow: none;" onclick="return confirm('Are you sure you want to delete this product?');">
