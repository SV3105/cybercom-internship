<div class="admin-container">
    ...
    <div class="export-options" style="margin: 0 2rem;">
        <form action="<?= BASE_URL ?>vendor/productsave" method="POST" enctype="multipart/form-data" style="max-width: 800px; margin: 0 auto;">
            <?php if ($product): ?>
            ...
            <div class="form-actions" style="display: flex; gap: 1rem; justify-content: flex-end;">
                <a href="<?= BASE_URL ?>vendor/products" class="btn-secondary">Cancel</a>
