        ...
        <div class="checkout-form-container">
                                ...
                                <div class="form-row">
                                    <div class="form-group">
                                        ...
                                        <div class="input-icon-wrapper">
                                            ...
                                            <input type="text" placeholder="MM/YY" maxlength="5" id="checkoutExpiry">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label>CVV</label>
                                        <div class="input-icon-wrapper">
                                            ...
                                            <input type="password" placeholder="123" maxlength="3" id="checkoutCVV">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
            ...
            <div class="checkout-step" id="step-3" style="display: none;">
                ...
                <div class="step-actions">
                    ...
                    <!-- Form for final submission handled by JS gathering data from previous steps -->
                    <form id="checkoutForm">
                        <input type="hidden" id="checkoutName" value=""> <!-- Populated by JS for validation sync -->
                        <input type="hidden" id="checkoutEmail" value="">
                        <input type="hidden" id="checkoutAddress" value="">
                        <input type="hidden" id="checkoutCity" value="">
                        <input type="hidden" id="checkoutZip" value="">
...
<script src="<?php echo $base_path; ?>js/checkout.js?v=<?php echo time(); ?>"></script>
